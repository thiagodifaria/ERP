...
export class GetCurrentWorkflowDefinitionVersion {
  public constructor(
  ...
  public async execute(definitionKey: string): Promise<WorkflowDefinitionVersion | null> {
    ...
    return this.versionRepository.findCurrentByWorkflowDefinitionId(definition.id);
  }
}
