...
export class GetWorkflowDefinitionVersionByNumber {
  public constructor(
  ...
  public async execute(definitionKey: string, versionNumber: number): Promise<WorkflowDefinitionVersion | null> {
    ...
    return this.versionRepository.findByWorkflowDefinitionIdAndVersionNumber(definition.id, versionNumber);
  }
}
