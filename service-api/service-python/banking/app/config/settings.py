...
def load_settings() -> Settings:
    return Settings(
        service_name=os.getenv("BANKING_SERVICE_NAME", "banking"),
        http_port=int(os.getenv("BANKING_HTTP_PORT", "8106")),
        repository_driver=os.getenv("BANKING_REPOSITORY_DRIVER", "memory"),
        bootstrap_tenant_slug=os.getenv("BANKING_BOOTSTRAP_TENANT_SLUG", "bootstrap-ops"),
        postgres_host=os.getenv("BANKING_POSTGRES_HOST", "service-postgresql"),
        postgres_port=int(os.getenv("BANKING_POSTGRES_PORT", "5432")),
        ...
        postgres_ssl_mode=os.getenv("BANKING_POSTGRES_SSL_MODE", "disable"),
    )
