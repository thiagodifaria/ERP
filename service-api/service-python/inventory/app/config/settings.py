...
def load_settings() -> Settings:
    return Settings(
        service_name=os.getenv("INVENTORY_SERVICE_NAME", "inventory"),
        http_port=int(os.getenv("INVENTORY_HTTP_PORT", "8104")),
        repository_driver=os.getenv("INVENTORY_REPOSITORY_DRIVER", "memory"),
        bootstrap_tenant_slug=os.getenv("INVENTORY_BOOTSTRAP_TENANT_SLUG", "bootstrap-ops"),
        postgres_host=os.getenv("INVENTORY_POSTGRES_HOST", "service-postgresql"),
        postgres_port=int(os.getenv("INVENTORY_POSTGRES_PORT", "5432")),
        ...
        postgres_ssl_mode=os.getenv("INVENTORY_POSTGRES_SSL_MODE", "disable"),
    )
