...
def build_compliance_control(tenant_slug: str | None = None) -> dict:
    ...
    if settings.repository_driver != "postgres":
        return {
            ...
            "documentOperations": {"events": 6, "providerReady": False},
            "privacy": {"requests": 2, "pending": 1},
            "consents": {"granted": 3, "revoked": 1},
            "retention": {"policies": 5, "restrictedDocuments": 10},
            "audit": {"events": 12},
            "readiness": {"status": "stable", "fiscalReady": True, "privacyReady": True, "retentionReady": True, "providerReady": False},
        }
