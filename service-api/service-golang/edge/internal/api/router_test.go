...
func buildTestRouter() http.Handler {
	return NewRouter(
		...
		handler.NewCoreOperationsOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
		handler.NewRelationshipOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
		handler.NewComplianceOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
		handler.NewGoLiveOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
		...
		handler.NewSaaSOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
		handler.NewContractsOverviewHandler("edge", "http://analytics.local", stubHealthChecker{}),
