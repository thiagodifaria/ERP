...
func NewRouter(
	...
	mux.HandleFunc("GET /api/crm/leads/export", leadHandler.Export)
	mux.HandleFunc("POST /api/crm/leads", leadHandler.Create)
	mux.HandleFunc("POST /api/crm/leads/bulk", leadHandler.BulkCreate)
	...
	mux.HandleFunc("GET /api/crm/enrichment/cnpj/capabilities", intelligenceHandler.CNPJCapabilities)
	mux.HandleFunc("POST /api/crm/enrichment/cnpj/lookup", intelligenceHandler.LookupCNPJ)
