...
config :workflow_runtime,
  ...
  postgres_database: System.get_env("WORKFLOW_RUNTIME_POSTGRES_DB", "change-me-unsafe-local-only-postgres"),
  postgres_username: System.get_env("WORKFLOW_RUNTIME_POSTGRES_USER", "change-me-unsafe-local-only-postgres"),
  postgres_password: System.get_env("WORKFLOW_RUNTIME_POSTGRES_PASSWORD", "change-me-unsafe-local-only-postgres"),
