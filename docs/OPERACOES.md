...
- `./scripts/db.sh summary workflow-control <tenant-slug>` resume total de definicoes, versoes publicadas, distribuicao por status e a ultima versao publicada por tenant
